...
//        输入: nums = [1,3,-1,-3,5,3,4,6,7], 和 k = 3
//        输出: [3,3,5,5,5,6,7]
//
...
//        i=6,nums[6]=4。队尾值为4，3<4，依次弹出后加入。队列：{5,4}。此时L=4,R=6，有效。result=[3,3,5,5,5]
//        i=7,nums[7]=6。队尾值为3，6>4，依次弹出后加入。队列：{6}。此时L=5,R=7，有效。result=[3,3,5,5,5,6]
//        i=8,nums[8]=7。队尾值为7，7>6，弹出队尾值后加入。队列：{7}。此时L=6,R=8，有效。result=[3,3,5,5,5,6,7]
