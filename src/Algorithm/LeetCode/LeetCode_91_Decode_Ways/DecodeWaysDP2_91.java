package Algorithm.LeetCode.LeetCode_91_Decode_Ways;// https://leetcode-cn.com/problems/decode-ways/solution/javajie-ti-si-lu-xiang-jie-by-zackqf/
...
class DecodeWaysDP2Main {
    public static void main(String[] args) {
        DecodeWaysDP2 decodeWays = new DecodeWaysDP2();
